    ...
    struct json_parser : public rpoco::visitor {
        ...
        void consume_frac_and_exp() {
            ...
            if (ins->peek() == '.') {
				...
				decimal_point = ".";
#else
				auto locale_data = localeconv();
				decimal_point = locale_data->decimal_point;
#endif
                // but append the locale decimal point
                tmp.append(decimal_point);
